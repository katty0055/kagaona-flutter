...
class QuoteScreenState extends State<QuoteScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text(CotizacionConstantes.titleApp)),
      ...
      body: RefreshIndicator(
        ...
        child:
            _quotes.isEmpty && _isLoading
                ...
                ? Center(
                  child: Text(
                    CotizacionConstantes.emptyList,
                              ...
                              Row(
                                ...
                                children: [
                                  Column(
                                    ...
                                    children: [
                                      Text(
                                        CotizacionConstantes.stockPrice,
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Text(
                                        CotizacionConstantes.lastUpdated,
                                        style: theme.textTheme.bodySmall
                                            ?.copyWith(
                                              color: theme.colorScheme.onSurface
                                                  .withAlpha(154),
